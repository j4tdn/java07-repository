...
public class EmployeeViews {
	public static final int AGE = 65;

	public static void main(String[] args) {
		List<Employee> emps = getEmployees();
		Employee newEm = new Employee(26, "Hai Sau", 26, Title.Dev);
		emps.add(newEm);
		emps.forEach(emp -> System.out.println(emp));
		Employee emById = getEmp(emps, 22);
		System.out.println("=============================================");
		System.out.println("EmpById:" + emById);
		System.out.println("=============================================");
		emps.removeIf(emp -> emp.getAge() > AGE);
		emps.remove(newEm);
		Employee emp2 = new Employee(13, "Hoang Teo", 20, Title.President);
		// emps.remove(emp2);
		// emps.contains(emp2);
		emps.forEach(emp -> System.out.println(emp));
		System.out.println("contains:" + emps.contains(emp2));
	}
	...
	private static List<Employee> getEmployees() {
		...
		// turn Arrays.asList(emp1, emp2, emp3, emp4, emp5);
		emps.add(emp1);
		emps.add(emp2);
		emps.add(emp3);
		emps.add(emp4);
