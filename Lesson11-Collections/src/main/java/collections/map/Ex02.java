...
public class Ex02 {
	public static void main(String[] args) {
		...
		Employee l1 = new Employee(1, "Le Na", 60, Title.Dev);
		...
		Employee l2 = new Employee(1, "Le Le", 60, Title.Dev);
		Employee e4 = new Employee(44, "Hoang Hoang", 20, Title.President);
		Employee e5 = new Employee(45, "Van Van", 30, Title.Dev);
