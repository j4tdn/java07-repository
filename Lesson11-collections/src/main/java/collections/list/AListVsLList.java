...
public class AListVsLList {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < COUNT; i++) {
			alist.add(1000, "element # " + i);
		}
		System.out.println("Add at index 49000: " + COUNT + " elements: ArrayList took "
				+ (System.currentTimeMillis() - start) + "ms");

		start = System.currentTimeMillis();
		for (int i = 0; i < COUNT; i++) {
			llist.add(1000, "element # " + i);
		}
		System.out.println("Add at index 49000: " + COUNT + " elements: LinkedList took "
				+ (System.currentTimeMillis() - start) + "ms");
